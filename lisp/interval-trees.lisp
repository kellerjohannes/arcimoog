...
(defparameter *vicentino-enarmonico*
  '((ottava . ((ottava-minore . diesis-minore)
    ...
    (sesta-minima . ((quinta-propinqua . diesis-minore)
                     (quinta . semitono-minore)
                     (quinta-imperfetta-propinqua . semitono-maggiore)
                     (quinta-imperfetta . tono-minore)
                     (tritono . tono)
                     (quarta-propinqua . tono-maggiore)
                     (quarta . terza-minima)
    ...
    (semitono-maggiore . ((semitono-minore . diesis-minore)
                          (diesis-maggiore . diesis-minore)))
    (diesis-maggiore . ((diesis-minore . diesis-minore)))
