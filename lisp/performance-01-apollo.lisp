(in-package :arcimoog.performance.apollo)

(format t "~&Loading live set for performance 01, Apollo Kreuzlingen, playmob.il & Arcimoog.")

;;; Sketches for Apollo Kreuzlingen, not in use for live set. For performance relevant code see below.
;;; STARTING HERE
...
(format t "~&Live set Apollo ready, change into package :apollo to use it.")
