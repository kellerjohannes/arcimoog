...
(defun interpret-note-value (note-value)
  (get-note-value note-value))

(defun parse-singing (singing-data)
  ;; Transform note value into numeric form.
  (list :s (interpret-note-value (first singing-data))))

(defun parse-tacet (tacet-data)
  ;; Transform note value into numeric form.
  (list :t (interpret-note-value (first tacet-data))))
...
(defparameter *test-melody* '((:i quinta :➚) (:s semibrevis) (:i tono :➘) (:t brevis)
                              (:i quarta :➘) (:i terza-minore :➚) (:i terza-minore :➚)
                              (:i terza-minore :➚) (:i terza-minore :➚)))

;;(defparameter *bassus* '((:s )))
